  ...
  <div>
    ...
    <div class="card" style="margin-bottom: 5px">
      <el-table stripe :data="data.tableData" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="specials" label="特色">
          <template #default="scope">
    ...
    <el-dialog title="旅游商品" v-model="data.formVisible" width="50%" destroy-on-close>
      <el-form ref="form" :model="data.form" label-width="70px" style="padding: 20px">
        ...
        <el-form-item label="简介" prop="descr">
          <el-input type="textarea" :rows="3" v-model="data.form.descr" placeholder="简介"></el-input>
        </el-form-item>
        ...
        <el-form-item label="特色" prop="specials">
          <el-select multiple v-model="data.form.specials">
            <el-option value="赠星级酒店"></el-option>
            <el-option value="纯玩无购物"></el-option>
            <el-option value="赠接机服务"></el-option>
            <el-option value="赠旅拍服务"></el-option>
            <el-option value="无自然单房差"></el-option>
          </el-select>
        </el-form-item>
...
const add = () => {
  ...
  request.post('/tourism/add', data.form).then(res => {
    if (res.code === '200') {
...
const update = () => {
  request.put('/tourism/update', data.form).then(res => {
    if (res.code === '200') {
      ElMessage.success('操作成功')
      data.formVisible = false
      load()
