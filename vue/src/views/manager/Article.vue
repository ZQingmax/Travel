<template>
  <div>
      ...
      <el-table stripe :data="data.tableData" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="cover" label="封面">
          <template #default="scope">
            <el-image :src="toFileUrl(scope.row.cover)" style="width: 50px; height: 50px; border-radius: 5px"
                      :preview-src-list="[toFileUrl(scope.row.cover)]" preview-teleported></el-image>
          </template>
        </el-table-column>
    ...
    <el-dialog title="旅游信息攻略" v-model="data.formVisible" width="40%" destroy-on-close>
      <el-form ref="form" :model="data.form" label-width="70px" style="padding: 20px">
        <el-form-item prop="title" label="标题">
          <el-input v-model="data.form.title" placeholder="请输入标题"></el-input>
        </el-form-item>
        <el-form-item rows="5" type="textarea" prop="descr" label="简介">
          <el-input type="textarea" :rows="4" v-model="data.form.descr" placeholder="请输入简介"></el-input>
        </el-form-item>
...
const preview = (content) => {
  data.content = content;    // 将内容赋值给 data.content
  data.formVisibleContent = true; // 打开预览弹窗
}
/* wangEditor5 初始化开始 */
