  ...
  <div class="manager-container">
    <div class="manager-header">
      <div class="manager-header-left">
        <img src="@/assets/imgs/logo(mini).png" alt="">
        <div class="title" style="font-size: 14px;">WanderLens后台管理</div>
      </div>
      ...
      <div class="manager-main-left">
        ...
        >
          ...
          <el-sub-menu index="1">
            ...
            <el-menu-item index="/manager/tourism">商品信息</el-menu-item>
            <el-menu-item index="/manager/orders">订单信息</el-menu-item>
            <el-menu-item index="/manager/travels">游记信息</el-menu-item>
            <el-menu-item index="/manager/routes">路线信息</el-menu-item>
            <el-menu-item index="/manager/article">攻略信息</el-menu-item>
            <el-menu-item index="/manager/comment">评论信息</el-menu-item>
            <el-menu-item index="/manager/collect">用户收藏</el-menu-item>
            <el-menu-item index="/manager/myFeedback">反馈信息</el-menu-item>
